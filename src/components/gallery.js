                ...
                <Link key={index} to={`${lastUrl}&pic=${index}`}>
                  <div className="overflow-hidden hover-parent position-relative img-hover img-hover mb-theme rounded shadow-lg">
                    ...
                    <motion.div
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={(event) => handleSave(3, event)}
                      className="position-absolute rounded hover-only-opacity-1 top-theme-2 left-theme-2 d-inline-flex"
                    >
                      <div className="d-inline-flex p-3 hover-blur bg-w-50 rounded">
                        <FontAwesomeIcon
                          className="text-danger h4 mb-0"
                          icon={["fa", "heart"]}
                        />
                      </div>
                    </motion.div>
